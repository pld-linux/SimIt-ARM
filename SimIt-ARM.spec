...
SimIt-ARM powstał do demonstracji przydatności modelu OSM (Operation
State Machine - automatu operacji) oraz języka MADL (Mescal
Architecture Description Language). Pakiet zawiera symulator zestawu
instrukcji (czasem zwany emulatorem) oraz dokładny co do cyklu
symulator architektury StrongARM. Oba symulatory czytają binaria ELF32
little-endian dla platformy ARM-linux i mogą symulować większość
testów wydajnościowych SPEC Int i SPEC FP.
